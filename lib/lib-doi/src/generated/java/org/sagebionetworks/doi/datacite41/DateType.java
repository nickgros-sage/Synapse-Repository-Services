...
public enum DateType {
    ...
    public static org.sagebionetworks.doi.datacite41.DateType fromValue(String v) {
        for (org.sagebionetworks.doi.datacite41.DateType c: org.sagebionetworks.doi.datacite41.DateType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
