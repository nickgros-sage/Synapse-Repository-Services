...
public enum DescriptionType {
    ...
    public static org.sagebionetworks.doi.datacite41.DescriptionType fromValue(String v) {
        for (org.sagebionetworks.doi.datacite41.DescriptionType c: org.sagebionetworks.doi.datacite41.DescriptionType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
