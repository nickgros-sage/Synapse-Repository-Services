...
public class EntityDoiManagerEzidImpl implements EntityDoiManager {

	private final Logger logger = LogManager.getLogger(EntityDoiManagerEzidImpl.class);
	...
	private final DoiMetadata metadata = new EzidMetadata();
	private final DxAsyncClient dxAsyncClient;

	public EntityDoiManagerEzidImpl() {
